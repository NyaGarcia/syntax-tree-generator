...
export class Rule {
    ...
    constructor(private nonTerminal: NonTerminal, private symbols: SymbolList, private value: String) {}
    ...
    containsValue(value: String): Boolean {
        return this.nonTerminal.contains(value) || this.symbols.includesValue(value);
    }
